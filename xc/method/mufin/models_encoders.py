...
class ModalEncoder(Base):
    ...
    def freeze_params(self):
        ...
        if self.txt_encoder is not None:
            self.txt_encoder.freeze_params()
...
class MultiModalRanker(Base):
    def __init__(self, params):
        ...
        self.attn_encoder.txt_encoder.lr_mf = params.lr_mf_enc
        self.attn_encoder.img_encoder.lr_mf = params.lr_mf_enc
        self.attn_encoder.optim = "AdamW"
        self.attn_encoder.lr_mf = 0.01
