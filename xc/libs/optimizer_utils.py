...
class Optimizer(object):
    def __init__(self, special=["bias", "LayerNorm"], type_scheudle="cosine"):
        self.optimizer = {}
        self.scheudler = {}
    ...
    def _get_opt(self, optim, is_sparse, params):
        if optim == 'Adam':
            ...
            if is_sparse == "sparse":
                raise NotImplementedError("Sparse AdamW is not supported")
    ...
    def construct(self, model, lr=0.01, trn_dl=[], warmup_steps=1000,
        ...
        self.clear()
        string = f"""
        args=(warmup_steps={warmup_steps}, num_epochs={num_epochs},
